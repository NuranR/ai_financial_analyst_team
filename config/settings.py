...
class Settings(BaseSettings):
    ...
    # Data Sources
    alpha_vantage_base_url: str = Field("https://www.alphavantage.co/query", env="ALPHA_VANTAGE_BASE_URL")
    news_api_base_url: str = Field("https://newsapi.org/v2", env="NEWS_API_BASE_URL")
    sec_edgar_base_url: str = Field("https://www.sec.gov/Archives/edgar", env="SEC_EDGAR_BASE_URL")
    ...
    mlflow_experiment_name: str = Field("afin_anomaly_detection", env="MLFLOW_EXPERIMENT_NAME")
