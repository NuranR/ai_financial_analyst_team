...
class SECFilingsFetcher:
    ...
    def get_company_filings(self, ticker: str, filing_types: List[str] = None, limit: int = 5) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if response.status_code != 200:
                logger.warning(f"Could not fetch SEC data for {ticker}, using mock data")
                return self._get_mock_filing_data(ticker)
    ...
    def extract_filing_insights(self, filing_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                'regulatory_health': self._assess_regulatory_health(filing_frequency, risk_signals)
            }
    ...
    def _assess_regulatory_health(self, filing_frequency: Dict[str, int], risk_signals: List[str]) -> str:
