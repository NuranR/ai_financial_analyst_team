...
class NewsAPI:
    ...
    def _is_relevant_article(self, article: Dict, ticker: str, company_name: str) -> bool:
        ...
        irrelevant_keywords = ['recipe', 'sports', 'weather', 'entertainment', 'celebrity']
    ...
    def _calculate_relevance(self, article: Dict, ticker: str, company_name: str) -> float:
        ...
        financial_keywords = ['earnings', 'revenue', 'profit', 'stock', 'shares', 'market', 'analyst', 'forecast']
...
class MockNewsAPI:
    ...
    def get_company_news(self, company_name: str, ticker: str, **kwargs) -> List[Dict[str, Any]]:
